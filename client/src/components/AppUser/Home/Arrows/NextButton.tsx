...
import RandomPropsType from './RandomPropsType';

const NextButton: FC<RandomPropsType> = (props) => {
    const { onClick } = props;

    return (
        <button className={st.arrowNext} type="button" onClick={onClick}>
            <svg aria-hidden="true" data-icon="chevron-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
